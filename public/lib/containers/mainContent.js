        ...
        <Section icon="FavoriteList" title="Project highlights">
          <ul>
            ...
            <Project
              from="Nov 2016"
              to="Apr 2017"
              title="Exhibition app with mobile positioning technology for Hong Kong Baptist University"
            >
              <p>Designed and developed an exhibition app and middleware for Hong Kong Baptist University. Implemented in React Native, Redux, and MongoDB, supported on iOS and Android, and hosted on Windows Azure Web App, the system talk to OpenWrt routers and REST-based positioning system, display kiosk information and exhibition map to enhance the visitors' experience.</p>
            </Project>
            <Project
              from="Oct 2016"
              title="Baggage management system for Hong Kong International Airport"
            >
              <p>Designed and developed frontend for baggage management system using React, Redux, Webpack, Bootstrap, and MongoDB. Integrate with backend using REST and MongoDB, the web app is able to find bags arrived seconds ago. Incoming data is very dynamic and accurate reporting is required. PDF reporting is achieved thru shipping Redux store to print server implemented in Node.js and rendered in PhantomJS.</p>
            </Project>
            <Project
              from="May 2016"
            ...
            >
              <p>Co-designed and co-developed a high-performance web app prototype for Hong Kong Jockey Club using cutting edge technologies: HTML5, responsive CSS with Flexbox layout, React, Redux, and Electron. Interface with MongoDB and Solace thru Node.js middleware. Focusing on high-performance, demonstrated the potential of using latest web technologies for internal web app with high volume of data exchange.</p>
            </Project>
            <Project
              from="Feb 2016"
              title="Tender proposal with Accenture"
            >
              <p>Worked with Accenture, Avanade, Fjord and PacificLink on a tender proposal for an internal web app for Hong Kong Jockey Club. Designed system architecture and involved in presentation preparation. Appointed as the frontend architect lead and steering committee member to lead the technical direction for the proposing project.</p>
            </Project>
            <Project
              from="Oct 2016"
